...
LATEST_RELEASE_API_URL: Final = (
    "https://api.github.com/repos/brizzio/shortmaker/releases/latest"
)
LATEST_RELEASE_PAGE_URL: Final = (
    "https://github.com/brizzio/shortmaker/releases/latest"
)
...
RELEASE_CHECK_HEADERS: Final = {
    ...
    "User-Agent": "ShortMaker-Version-Checker",
}
...
class AsyncUpdateChecker:
    ...
    def _run_check(self, current_version: str) -> None:
        try:
            ...
            logger.exception(
                "unexpected error while checking for a ShortMaker update"
            )
